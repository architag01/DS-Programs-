//Write a menu driven program of a circular queue using linked list having add, delete and display operations[without taking global variables].
#include <stdio.h> 
# define max 6
...
enqueue(int element)
{
    ...
    {
        rear = (rear + 1) % max; // rear is incremented queue[rear]=element;
